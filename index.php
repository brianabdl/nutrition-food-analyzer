        ...
        <section class="search-section">
            <form method="GET" action="index.php" class="search-container">
                <div class="search-input-wrapper">
                    ...
                    <input type="text" name="search" id="searchInput" placeholder="Search for foods..."
                ...
                <section class="pagination-section" id="paginationSection">
                    <div class="pagination-container">
                        <div class="pagination-info">
                            <span>Showing <?php echo $showingStart; ?> to <?php echo $showingEnd; ?> of
                                <?php echo $totalCount; ?> foods</span>
                        </div>
